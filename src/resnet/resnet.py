# From pytorch's official implementation of resnet in torch vision https://pytorch.org/vision/0.8/_modules/torchvision/models/resnet.html
import torch
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.depth = 2 # number of relu layers
        self.stride = stride
    ...
    def forward_get_code(self, x):
        ...
        out = self.conv1(x)
        out = self.bn1(out)
        out, activation_code_relu_1 = self.relu.forward_get_code(out)
        activation_codes.append(activation_code_relu_1)
        out = self.conv2(out)
        out = self.bn2(out)
        ...
        out += identity
        out, activation_codes_relu_out = self.relu.forward_get_code(out)
        activation_codes.append(activation_codes_relu_out)
